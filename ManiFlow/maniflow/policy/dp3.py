...
from maniflow.model.diffusion.conditional_unet1d import ConditionalUnet1D
from maniflow.model.diffusion.mask_generator import LowdimMaskGenerator
...
class DP3(BasePolicy):
    def __init__(self, 
        ...
        cprint(f"[DP3] language_conditioned: {self.language_conditioned}", "yellow")
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if self.language_conditioned:
            ...
            assert lang_cond is not None, "task_name must be provided for language conditioned model"
    ...
    def compute_loss(self, batch):
        ...
        noisy_trajectory = self.noise_scheduler.add_noise(
            trajectory, noise, timesteps).to(trajectory.device)
